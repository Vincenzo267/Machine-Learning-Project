...
#define AI_NETWORK_MODEL_SIGNATURE     "e14e0919f32d7c3626b3fa80792ef28e"
...
#define AI_TOOLS_DATE_TIME   "Wed Nov 24 13:47:02 2021"
...
AI_STATIC ai_array input_10_output_array;   /* Array #0 */
AI_STATIC ai_array conv1d_14_output_array;   /* Array #1 */
AI_STATIC ai_array conv1d_15_output_array;   /* Array #2 */
AI_STATIC ai_array dense_9_output_array;   /* Array #3 */
AI_STATIC ai_array dense_9_nl_output_array;   /* Array #4 */
AI_STATIC ai_array conv1d_14_weights_array;   /* Array #5 */
AI_STATIC ai_array conv1d_14_bias_array;   /* Array #6 */
AI_STATIC ai_array conv1d_15_weights_array;   /* Array #7 */
AI_STATIC ai_array conv1d_15_bias_array;   /* Array #8 */
AI_STATIC ai_array dense_9_weights_array;   /* Array #9 */
AI_STATIC ai_array dense_9_bias_array;   /* Array #10 */
AI_STATIC ai_array conv1d_15_scratch0_array;   /* Array #11 */


/**  Forward network tensor declarations  *************************************/
AI_STATIC ai_tensor input_10_output;   /* Tensor #0 */
AI_STATIC ai_tensor conv1d_14_output;   /* Tensor #1 */
AI_STATIC ai_tensor conv1d_15_output;   /* Tensor #2 */
AI_STATIC ai_tensor dense_9_output;   /* Tensor #3 */
AI_STATIC ai_tensor dense_9_nl_output;   /* Tensor #4 */
AI_STATIC ai_tensor conv1d_14_weights;   /* Tensor #5 */
AI_STATIC ai_tensor conv1d_14_bias;   /* Tensor #6 */
AI_STATIC ai_tensor conv1d_15_weights;   /* Tensor #7 */
AI_STATIC ai_tensor conv1d_15_bias;   /* Tensor #8 */
AI_STATIC ai_tensor dense_9_weights;   /* Tensor #9 */
AI_STATIC ai_tensor dense_9_bias;   /* Tensor #10 */
AI_STATIC ai_tensor conv1d_15_scratch0;   /* Tensor #11 */


/**  Forward network tensor chain declarations  *******************************/
AI_STATIC_CONST ai_tensor_chain conv1d_14_chain;   /* Chain #0 */
AI_STATIC_CONST ai_tensor_chain conv1d_15_chain;   /* Chain #1 */
AI_STATIC_CONST ai_tensor_chain dense_9_chain;   /* Chain #2 */
AI_STATIC_CONST ai_tensor_chain dense_9_nl_chain;   /* Chain #3 */


/**  Forward network layer declarations  **************************************/
AI_STATIC ai_layer_conv2d conv1d_14_layer; /* Layer #0 */
AI_STATIC ai_layer_conv2d_nl_pool conv1d_15_layer; /* Layer #1 */
AI_STATIC ai_layer_dense dense_9_layer; /* Layer #2 */
AI_STATIC ai_layer_nl dense_9_nl_layer; /* Layer #3 */
...
/* Array#4 */
AI_ARRAY_OBJ_DECLARE(
  dense_9_nl_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 4, AI_STATIC)
...
/* Array#11 */
AI_ARRAY_OBJ_DECLARE(
  conv1d_15_scratch0_array, AI_ARRAY_FORMAT_FLOAT,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 5, 32), AI_STRIDE_INIT(4, 4, 4, 4, 20),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  7, 0x0,
  AI_SHAPE_INIT(4, 32, 1, 5, 48), AI_STRIDE_INIT(4, 4, 128, 128, 640),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  9, 0x0,
  AI_SHAPE_INIT(4, 48, 4, 1, 1), AI_STRIDE_INIT(4, 4, 192, 768, 768),
...
/* Tensor #11 */
AI_TENSOR_OBJ_DECLARE(
  conv1d_15_scratch0, AI_STATIC,
  11, 0x0,
  AI_SHAPE_INIT(4, 1, 48, 1, 120), AI_STRIDE_INIT(4, 4, 4, 192, 192),
  1, &conv1d_15_scratch0_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &input_10_output),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv1d_15_scratch0)
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 38592, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &input_10_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &dense_9_nl_output),
